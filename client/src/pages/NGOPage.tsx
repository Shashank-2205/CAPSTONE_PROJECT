...
export default function NGOPage({ onBack, onRequestHelp, pageInfo }: NGOPageProps) {
  return (
    <main className="app-shell volunteer-page-shell">
      <div className="page-top-actions">
        <div className="page-header-back">
          <span className="page-role-tag">NGO</span>
      ...
      <header className="topbar-shell">
        <nav className="topbar-nav" aria-label="NGO navigation">
          <button type="button" className="topbar-tab active">NGO</button>
        </nav>
      </header>
      ...
      <section className="role-page-view" aria-live="polite">
        <div className="role-page-header">
          <div className="role-page-toolbar">
            <span className="eyebrow mini">NGO console</span>
          </div>
        ...
        <div className="volunteer-section-grid">
          ...
          <div className="panel volunteer-panel accent-panel">
            ...
            <div className="cta-row stacked-actions">
              <button type="button" className="primary-btn">Dispatch aid</button>
              <button type="button" className="secondary-btn">Review inventory</button>
              <button type="button" className="secondary-btn">Track delivery</button>
            </div>
          </div>
        </div>
      </section>
